...
-- Safe global patching
if not replicatesignal then replicatesignal = Volcano.API.replicate_signal end
if not debug.getstack then debug.getstack = Volcano.API.get_stack end
if not debug.setstack then debug.setstack = Volcano.API.set_stack end
if not getscripts then getscripts = Volcano.API.get_scripts end
if not isscriptable then isscriptable = Volcano.API.is_scriptable end
